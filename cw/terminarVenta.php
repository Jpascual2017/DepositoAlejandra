...
$Gastos = $_POST["Gastos"];
$TotalEfectivo=$total-$Descuentos-$Gastos;
...
$sentencia = $base_de_datos->prepare("INSERT INTO ventas(fecha, total,Descuentos,Gastos,TotalEfectivo) VALUES (?, ?,?,?,?);");
$sentencia->execute([$ahora, $total,$Descuentos, $Gastos,$TotalEfectivo]);
